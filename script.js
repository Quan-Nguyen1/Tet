  ...
  try {
    ...
    tetMusic
      ...
      .catch((error) => {
        ...
        console.log(
          "ℹ️ Trình duyệt chặn autoplay. Click vào nút play để phát nhạc!",
        );
...
function updateMusicButtonUI() {
  ...
  if (musicBtn) {
    if (isMusicPlaying) {
      musicBtn.innerHTML =
        '<i class="fas fa-pause-circle"></i><span class="music-text">Tắt nhạc Tết</span>';
      musicBtn.style.background = "linear-gradient(45deg, #4CAF50, #45a049)";
    } else {
      musicBtn.innerHTML =
        '<i class="fas fa-music"></i><span class="music-text">Bật nhạc Tết</span>';
      musicBtn.style.background =
        "linear-gradient(45deg, var(--primary-red), var(--dark-red))";
    }
  }
}
  ...
  const zodiacData = [
    {
      ...
      prediction:
        "Năm Ngọ khắc với Tý nên cần thận trọng. Tuy nhiên, công việc có nhiều cơ hội phát triển, tài chính ổn định.",
    },
    {
      id: "suu",
      name: "Sửu",
      ...
      prediction:
        "Năm khá thuận lợi cho Sửu. Công việc ổn định, tài chính có dấu hiệu tăng trưởng. Tình cảm gia đình hạnh phúc.",
    },
    {
      id: "dan",
      name: "Dần",
      ...
      prediction:
        "Năm Dần gặp nhiều may mắn. Sự nghiệp thăng tiến, tài lộc dồi dào. Cần chú ý sức khỏe và các mối quan hệ.",
    },
    {
      id: "mao",
      name: "Mão",
      ...
      prediction:
        "Năm bình ổn cho Mão. Công việc có thể gặp một số thử thách nhỏ nhưng sẽ vượt qua. Tình cảm ổn định.",
    },
    {
      id: "thin",
      name: "Thìn",
      ...
      prediction:
        "Năm cực kỳ tốt cho Thìn. Thăng tiến vượt bậc trong sự nghiệp, tài lộc dồi dào. Mọi việc đều thuận lợi.",
    },
    {
      id: "ti",
      name: "Tỵ",
      ...
      prediction:
        "Năm có nhiều biến động cho Tỵ. Cần thận trọng trong đầu tư và các quyết định quan trọng. Sức khỏe cần chú ý.",
    },
    {
      id: "ngo",
      name: "Ngọ",
      ...
      prediction:
        "Năm Bản Mệnh! Ngọ gặp nhiều may mắn, công việc thuận lợi, tài lộc dồi dào. Đây là năm để phát triển vượt bậc.",
    },
    {
      id: "mui",
      name: "Mùi",
      ...
      prediction:
        "Năm hòa hợp với Mùi. Công việc ổn định, tài chính có cải thiện. Tình cảm gia đình ấm áp, hạnh phúc.",
    },
    {
      id: "than",
      name: "Thân",
      ...
      prediction:
        "Năm nhiều thách thức cho Thân. Cần kiên nhẫn và cẩn trọng trong mọi việc. Tuy nhiên, cuối năm sẽ có kết quả tốt.",
    },
    {
      id: "dau",
      name: "Dậu",
      ...
      prediction:
        "Năm khá tốt cho Dậu. Công việc có nhiều cơ hội mới, tài chính ổn định. Cần chú ý các mối quan hệ xã giao.",
    },
    {
      id: "tuat",
      name: "Tuất",
      ...
      prediction:
        "Năm bình ổn cho Tuất. Mọi việc diễn ra theo kế hoạch, ít biến động. Tình cảm và sức khỏe đều tốt.",
    },
    {
      id: "hoi",
      name: "Hợi",
      ...
      prediction:
        "Năm thuận lợi cho Hợi. Công việc có bước tiến mới, tài chính khả quan. Gia đình hạnh phúc, con cháu hiếu thảo.",
    },
  ];
...
function getZodiacAdvice(zodiacId) {
  ...
  return (
    advice[zodiacId] ||
    "Nên giữ vững tinh thần lạc quan, làm việc chăm chỉ và quan tâm đến gia đình."
  );
}
...
function testTetArrival() {
  ...
  console.log(
    "🎆 Tết sẽ đến sau 1 giây! Chuẩn bị xem pháo hoa và nghe nhạc! 🎆",
  );
}
